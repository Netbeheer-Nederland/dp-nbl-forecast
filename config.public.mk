...
LINKML_SCHEMA_NAME=dp_nbl_forecast
LINKML_SCHEMA_AUTHOR=Ritger Teunissen <ritger.teunissen@alliander.com>
LINKML_SCHEMA_DESCRIPTION=Information model for data product forecast for Netbewust Laden.
LINKML_SCHEMA_SOURCE_PATH=src/dp_nbl_forecast/schema/dp_nbl_forecast.yaml
...
LINKML_GENERATORS_CONFIG_YAML= --config-file config.yaml --include jsonschema --include jsonldcontext
